...
rclone_script is a simple script written in bash that connect to my serivces via rclone. The rclone services are configured outside the script within rclone config itself.
